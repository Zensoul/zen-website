  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-3xl text-center">
        <h2 id="ps-heading" className="font-serif text-[1.6rem] sm:text-[1.9rem] font-semibold tracking-tight text-[--foreground]">
...
<div className="mx-auto mt-8 grid max-w-6xl gap-6 md:grid-cols-2">
  ...
  {/* Your Solutions — same solid light grey (slightly different tint for subtle contrast) */}
    ...
    <ul className="mt-4 space-y-5">
      ...
      <div className="mx-auto mt-8 flex max-w-3xl flex-col items-center justify-center gap-3 text-center sm:flex-row sm:justify-center">
        <Button
          ...
          onClick={() => push('ps_click', { item: 'consultation', problem: 'all' })}
        >
        ...
        <Button
          ...
          onClick={() => push('ps_click', { item: 'self_test', problem: 'all' })}
        >
          <Link href="/addiction-self-test" aria-label="Take the Free Addiction Self-Test">
            Take the Free Addiction Self-Test
          </Link>
        </Button>
      </div>

      {/* FAQPage JSON-LD for PAA/AI Overviews */}
